...
A fully responsive basketball skills academy website built with plain HTML, CSS and JavaScript (no build step required).
...
- Hero, About, Programs, Weekly Schedule, Testimonials, Pricing, CTA, and Contact sections
